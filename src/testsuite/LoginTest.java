...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials(){
        ...
        //Enter valid Email
        driver.findElement(By.id("email")).sendKeys("mahakagg@gmail.com");
        //Enter valid Password
        driver.findElement(By.id("pass")).sendKeys("Mahak123");
        //Click on ‘Sign In’ button
        driver.findElement(By.xpath("//span[text()='Sign In']")).click();
        //Verify Welcome text
       String expectedResult = "Welcome, Mahak Agarwal!";
       String actualResult = driver.findElement(By.xpath("//span[text()='Welcome, Mahak Agarwal!']")).getText();
    ...
    public void verifyTheErrorMessageWithInvalidCredentials(){
        ...
        driver.findElement(By.linkText("Sign In")).click();
        //Enter Invalid Email
        driver.findElement(By.id("email")).sendKeys("mahakagg123@gmail.com");
        //Enter Invalid Password
        driver.findElement(By.id("pass")).sendKeys("Mahak1234");
        //Click on ‘Sign In’ button
        driver.findElement(By.xpath("//span[text()='Sign In']")).click();
